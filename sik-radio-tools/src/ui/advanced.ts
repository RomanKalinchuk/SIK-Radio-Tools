...
export function renderAdvancedTab(container: HTMLElement, _state: AppState): void {
  container.innerHTML = `
    <div class="card">
  ...
  const regInput = document.getElementById('adv-register') as HTMLInputElement;
  const valInput = document.getElementById('adv-value') as HTMLInputElement;
